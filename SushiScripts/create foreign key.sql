...
ADD
	CONSTRAINT FK_TEMP_CART_CTMONAN
	FOREIGN KEY (MACTMON)
	REFERENCES CHITIETMONAN(MACTMON),

	CONSTRAINT FK_TEMP_CART_MAKH
	FOREIGN KEY (MAKH)
...
ALTER TABLE TRUYCAP
ADD 
	CONSTRAINT FK_TRUYCAP_MADHTRUCTUYEN
	FOREIGN KEY (MADHTRUCTUYEN)
	REFERENCES DATHANGTRUCTUYEN(MADHTRUCTUYEN)
	ON DELETE CASCADE
