...
(
    CustomerIdentifier CHAR(5),
	CustomerTelephoneNumber CHAR(10),
	CustomerName NVARCHAR(30),
	CustomerStreetAddress NVARCHAR(20),
	CustomerCity NVARCHAR(20),
	CustomerState NVARCHAR(20),
	CustomerZipCode INT,
	CustomerCreditRating FLOAT,
...
(
    CustomerCreditCardNumber INT,
	CustomerCreditCardName NVARCHAR(30),
...
(
	...
	CustomerIdentifier CHAR(5),
	OrderDate DATE,
	ShippingStreetAddress NVARCHAR(20),
	ShippingCity NVARCHAR(20),
	ShippingState NVARCHAR(20),
	ShippingZipCode INT,
	CustomerCreditCardNumber INT,
	ShippingDate DATE,
	OrderTotalAmount FLOAT, -- Thuộc tính mới tạo ra để chứa giá

	CONSTRAINT PK_ORDER
    PRIMARY KEY (OrderNumber),

	CONSTRAINT FK_CustomerCreditCardNumber_CustomerCreditCardNumber
	FOREIGN KEY (CustomerCreditCardNumber)
	REFERENCES CREDIT_CARD(CustomerCreditCardNumber)
	ON DELETE CASCADE,

CONSTRAINT FK_CustomerIdentifier_CustomerIdentifier
	FOREIGN KEY (CustomerIdentifier)
	REFERENCES CUSTOMER(CustomerIdentifier)
	ON DELETE CASCADE
)
...
(
	...
	SupplierStreetAddress NVARCHAR(20),
	SupplierCity NVARCHAR(20),
	SupplierState NVARCHAR(20),
	SupplierZipCode INT,
