...
GO
	...
	BEGIN
		...
		UPDATE D
		SET D.THANHTIEN = SUM(CT.DONGIATONG)
		FROM DONDATMON D
		JOIN CHITIETMONAN CT ON D.MADON = CT.MADONDATMON
	END
GO
...
GO
	...
	BEGIN
		...
		UPDATE HD
		SET HD.TONGTIEN = SUM(I.THANHTIEN) * (1 + HD.VAT) * (1 - KM.LUONGKMPHANTRAM)
		FROM HOADON HD
		INNER JOIN DONDATMON I ON HD.MAHOADON = I.HOADONLIENQUAN
